 ...
 * 可刷新&使用两个相同浮动布局
 */
public class RefreshFloatFragment extends Fragment implements OnScrollListener {
    ...
    public RefreshFloatFragment() {
    }

    public static RefreshFloatFragment newInstance() {
        RefreshFloatFragment fragment = new RefreshFloatFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_float_refresh, container, false);
